...
VkResult MagmaSwapChain::acquireNextImage(uint32_t *imageIndex) {
...
VkResult MagmaSwapChain::submitCommandBuffers(const VkCommandBuffer *buffers,
                                              uint32_t *imageIndex) {
...
void MagmaSwapChain::createSwapChain() {
...
void MagmaSwapChain::createImageViews() {
...
void MagmaSwapChain::createRenderPass() {
...
void MagmaSwapChain::createFramebuffers() {
...
void MagmaSwapChain::createDepthResources() {
...
void MagmaSwapChain::createSyncObjects() {
...
VkSurfaceFormatKHR MagmaSwapChain::chooseSwapSurfaceFormat(
...
VkExtent2D
MagmaSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
VkFormat MagmaSwapChain::findDepthFormat() {
